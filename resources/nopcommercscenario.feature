Feature: Demo Nopcommerce 's topmenu acceptance criteria
  ...
  Scenario:    Verify that user can see the Books category page with filters and list of products
   ...
   Then        Books category page is disolayed with filters and list tabs
  ...
  Scenario:    Verify that user can see 'Name: A to Z' is selection is present in 'Sort by' filter
    Given      User is on Books Category page
    When       User is on Books Category page
